...
namespace ConsoleApp1
{
    public class Program
    {
        ...
        {
            string[] fileTickets = File.ReadAllLines(@"C:\Users\gr622_yurnal\Desktop\lr1\Lr1.3\input.txt");
            ...
            File.WriteAllLines( @"C:\Users\gr622_yurnal\Desktop\lr1\Lr1.3\output.txt", result.ToArray());
        }
    }
}
*/
...
public class Program
{
    public static void Main(string[] args)
    {
        string[] file = File.ReadAllLines(@"C:\Users\gr622_yurnal\Desktop\lr1\Lr1.3\nums.txt");
        string file1 = @"C:\Users\gr622_yurnal\Desktop\lr1\Lr1.3\nums.txt";
...
namespace ConsoleApp1
{
    public class Program
    {
        public static void Main(string[] args)
        {
            string pathInput = @"C:\Users\gr622_yurnal\Desktop\lr1\Lr1.3\height.txt";
            int[] height;
